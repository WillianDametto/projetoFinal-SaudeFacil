...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg border p-[3px] dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400',
        className,
      )}
      {...props}
    />
